...
namespace App\Plugins\Integrations\Microsoft\Outlook\Entity;
...
#[ORM\Index(columns: ["outlook_event_id"])]
#[ORM\Index(columns: ["calendar_id"])]
class OutlookCalendarEventEntity
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\Column(name: "outlook_event_id", type: "string", length: 255)]
    ...
    #[ORM\Column(name: "web_link", type: "string", length: 512, nullable: true)]
    ...
    public function toArray(): array
    {
        return [
            ...
            'outlook_event_id' => $this->getOutlookEventId(),
