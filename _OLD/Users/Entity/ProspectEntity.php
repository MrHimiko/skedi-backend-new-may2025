...
use App\Plugins\Users\Repository\ProspectRepository;
use DateTimeInterface;

#[ORM\Entity(repositoryClass: ProspectRepository::class)]
#[ORM\Table(name: "users_prospects")]
class ProspectEntity
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column(name: "prospect_id", type: "integer")]
    private int $id;

    #[ORM\ManyToOne(targetEntity: UserEntity::class)]
    #[ORM\JoinColumn(name: "prospect_user_id", referencedColumnName: "id", nullable: false)]
