...
class TokenEntity
{
    ...
    #[ORM\JoinColumn(name: 'token_user_id', referencedColumnName: 'user_id', nullable: false, onDelete: 'CASCADE')]
    ...
    #[ORM\JoinColumn(name: "token_organization_id", referencedColumnName: "organization_id", nullable: false)]
